...
test-5090-fp8-reduction-repeat: $(SRC_5090_LOWP_REDUCTION_WIDTH)
	$(NVCC) $(NVCC_INCLUDES) -DTCNB_REDUCTION_FP8 -DTCNB_REDUCTION_REPEAT -o $@ -arch=$(GPU_COMPUTE_5090_ACCEL) -code=$(GPU_SM_5090_ACCEL) $(NVCC_STD) $<

test-5090-fp6-reduction-repeat: $(SRC_5090_LOWP_REDUCTION_WIDTH)
	$(NVCC) $(NVCC_INCLUDES) -DTCNB_REDUCTION_FP6 -DTCNB_REDUCTION_REPEAT -o $@ -arch=$(GPU_COMPUTE_5090_ACCEL) -code=$(GPU_SM_5090_ACCEL) $(NVCC_STD) $<
